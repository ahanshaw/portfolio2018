    ...
    <section id="about" class="about">
        <div class="about__container">
            ...
            <div class="about__item">
                ...
                <p>When I&#8217;m not coding, I&#8217;m probably out running. You can find me on the lakefront path every summer as a group leader for the Chicago Area Running Association&#8217;s <a target="_blank" rel="noopener noreferrer" href="https://cararuns.org/cs/cara/summer-marathon-chicago-training">Chicago Marathon training&nbsp;program</a>. In 2018 I ran my first (but not last)&nbsp;ultramarathon.</p>
